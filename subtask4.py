...
# lift_motor.on_to_position(20, -100)

turn_left_degrees(90, 5)

while (DA_diff.ultrasonic.distance_centimeters > 7.5):
    go_straight_in(0.2, 30, -90)

time.sleep(2)
lift_motor.on_to_position(20, lift_motor.position + 1800)

turn_right_degrees(90, 5)
